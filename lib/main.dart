...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _ListTileWidget(mq: mq, slides: slides, index: 3,),
    );
  }
}
      ...
      height: mq.size.height -100,
        ...
        child: Column(
          ...
          children: [
            ...
            Text(slides[index].title, textAlign: TextAlign.center,style: TextStyle(
            ...
            Text(slides[index].desc, textAlign: TextAlign.center,style: TextStyle(
                fontWeight: FontWeight.w500,
